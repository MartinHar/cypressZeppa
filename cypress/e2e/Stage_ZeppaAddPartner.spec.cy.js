...
let LOAdmin = {emailAddress:'lo24@sef.am', password:'Password1'}
let LGLAdmin = {emailAddress:'testlgl@sef.am', password:'Password3'}
...
describe('Add partner',() => {
    ...
    it('Zeppa login page, create potential partner',() => {
        ...
        // Admin code
        cy.get('.ant-form-item-control-input').eq(5).type('Y24').type('{enter}')
        // Address
    ...
    it('Filtering potential partner',() => {
        ...
        cy.wait(2000)
        //attach file //should be in fixtures path, and locator must contain type="file"
        for(let i = 0; i < 4; i ++){
    ...
    it.only('add chain',() => {
        ...
        // will be implemented with next staging > cy.get('[name="contactEmail"]').type(emailAddress)
        cy.wait(500)
