// Add partner - only super admin flow with Y20 branch
...
describe('Zeppa login page, create potential partner',() =>{

    beforeEach('login', () => {
        cy.loginToZeppaAdmin()
    })
    ...
    it.only('add chain',() => {
        ...
        cy.wait(500)
        cy.get('.ant-select-item-option-content').eq(25).click()
        cy.wait(500)
